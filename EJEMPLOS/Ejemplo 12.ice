{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "a9ceaf72-bc2a-43c8-b6b9-81fb521a1219",
          "type": "basic.output",
          "data": {
            "name": "LED ",
            "range": "[6:0]",
        ...
        {
          "id": "b81610ce-ef27-4522-bedb-7b3adb4d901e",
          "type": "basic.constant",
          "data": {
            "name": "milisegundos",
            "value": "1000",
        ...
        {
          "id": "447d11c6-e286-4be0-9ad7-97c7aa7b8914",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "10",
        ...
        {
          "id": "57bbc72f-99f5-439f-977f-ca862b9e6b2d",
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 12: Segundero\n\nSe usa un contador para contar la cantidad de segundos trenscurridos (desde 0 a 9).\nSe muestran en el display de 7 segmentos. CUando llega a 9 vuelve a empezar\ndesde 0.",
            "readonly": true
          },
          "position": {
            "x": -256,
        ...
        {
          "id": "0e679767-48d1-42c8-b810-003d8ca5efad",
        ...
        {
          "id": "014916d4-c78b-4503-a79b-db499d004728",
        ...
        {
          "id": "d061ff01-3305-4b60-a952-680c10956aae",
        ...
        {
          "id": "86f3ddda-b44d-44bc-b9bc-960122d7b794",
        ...
        {
          "id": "28f251bc-7bcb-4ec7-a7f5-a6c04361bd74",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "cc602d44-560b-42b9-bfc7-3e70a73eb357",
          "type": "basic.info",
          "data": {
            "info": "Evento: ha pasado un segundo",
            "readonly": true
          },
          "position": {
            "x": -32,
        ...
        {
          "id": "654ce745-ee3b-404d-9bd0-653922fa1315",
          "type": "basic.info",
          "data": {
      ...
      "wires": [
        {
          "source": {
            "block": "014916d4-c78b-4503-a79b-db499d004728",
            "port": "c659caa2-1cf7-4da3-855a-2b0c0ecc7510"
          },
          "target": {
            "block": "d061ff01-3305-4b60-a952-680c10956aae",
        ...
        },
        {
          ...
          "target": {
            "block": "a9ceaf72-bc2a-43c8-b6b9-81fb521a1219",
            "port": "in"
          },
          "size": 7
        },
        {
          "source": {
            "block": "0e679767-48d1-42c8-b810-003d8ca5efad",
        ...
        {
          "source": {
            "block": "86f3ddda-b44d-44bc-b9bc-960122d7b794",
        ...
        {
          "source": {
            "block": "b81610ce-ef27-4522-bedb-7b3adb4d901e",
            "port": "constant-out"
          },
          "target": {
            "block": "0e679767-48d1-42c8-b810-003d8ca5efad",
        ...
        {
          "source": {
            "block": "447d11c6-e286-4be0-9ad7-97c7aa7b8914",
            "port": "constant-out"
          },
          "target": {
            "block": "014916d4-c78b-4503-a79b-db499d004728",
