{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "814c2dff-7346-450a-99f4-c1bca0710e7b",
          "type": "basic.output",
          "data": {
            "name": "DISP",
            "range": "[6:0]",
        ...
        {
          "id": "7020b175-68a3-484b-ab5a-8cec99bf9e22",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "51dee337-1923-466c-a2c6-da4d5c196906",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "5952e2d9-51b0-4fab-b157-bffe8c2813b6",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "a4b15f73-b6c8-4efd-be42-920ec5742d29",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "327a405d-f51c-4d69-bb6e-84657c8bd2df",
          "type": "basic.constant",
          "data": {
            "name": "Modulo",
            "value": "10",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 6: Cambiando el modulo del contador\n\nContador de pulsaciones, que cuenta en decimal, ddesde el 0 hasta el 9\nse usa un contador de 4 bits modulo 10\n\n",
            "readonly": true
          },
          "position": {
            "x": -224,
        ...
        {
          "id": "d842cb02-5a0b-4cec-b91e-86a35e9bd642",
        ...
        {
          "id": "4588c310-e505-4589-9cf4-6f7c06046f15",
          "type": "basic.info",
          "data": {
            "info": "Pulsado para inicializar\n\n",
            "readonly": true
          },
          "position": {
            "x": 64,
        ...
        {
          "id": "959298eb-cc15-4529-aadd-658c8041e12c",
          "type": "basic.info",
          "data": {
            "info": "Tics de pulsador",
            "readonly": true
          },
          "position": {
            "x": 128,
        ...
        {
          "id": "66d3aeb2-1960-48c0-9362-f88c592d98ac",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "796508fa-ba06-4601-aaf6-c673fe66c04d",
        ...
        {
          "id": "e8bd78ac-150d-4b1a-b6a8-3173fa3e8c2c",
          "type": "basic.info",
          "data": {
            "info": "Notificacion de overflow",
            "readonly": true
          },
          "position": {
            "x": 656,
        ...
        {
          "id": "2206fc5e-db79-4e16-aeeb-aa8ce0ead072",
          "type": "basic.info",
          "data": {
            "info": "Borrar la \nnotificacion",
            "readonly": true
        ...
        {
          "id": "11ab3ba2-7865-4dd8-a7e3-51baf52861ea",
          "type": "basic.info",
          "data": {
            "info": "0: no overflow\n\n1: Overflow",
            "readonly": true
        ...
        {
          "id": "ac74d985-0508-4cf1-8ce3-dc3d3c7480c8",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "cd8d83e0-de3f-44fe-a749-6b9853884a16",
          "type": "basic.info",
          "data": {
            "info": "Desbordamiento",
            "readonly": true
        ...
        {
          "id": "8460c821-eb3b-4487-b95c-f4e0be56043c",
        ...
        {
          "id": "29419937-2d03-4f3b-a558-a759ed6f0a07",
        ...
        {
          "id": "318bde56-6a00-43e6-bc0c-2071ba383956",
          "type": "basic.info",
          "data": {
            "info": "Display DEC\n",
            "readonly": true
        ...
        {
          "id": "dfe786ac-d446-4b8e-b014-24fada268fa2",
          "type": "basic.info",
          "data": {
            "info": "Contador decimal",
            "readonly": true
          },
          "position": {
            "x": 296,
      ...
      "wires": [
        {
          "source": {
            "block": "51dee337-1923-466c-a2c6-da4d5c196906",
            "port": "out"
          },
          "target": {
            "block": "d842cb02-5a0b-4cec-b91e-86a35e9bd642",
            "port": "21bc142d-a93a-430d-b37a-326435def9f9"
          }
        },
        {
          "source": {
            "block": "796508fa-ba06-4601-aaf6-c673fe66c04d",
            "port": "1cb167a4-9e2a-416b-803e-da7b6151eaa5"
          },
          "target": {
            "block": "5952e2d9-51b0-4fab-b157-bffe8c2813b6",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "a4b15f73-b6c8-4efd-be42-920ec5742d29",
            "port": "out"
          },
          "target": {
            "block": "796508fa-ba06-4601-aaf6-c673fe66c04d",
        ...
        },
        {
          ...
          "target": {
            "block": "29419937-2d03-4f3b-a558-a759ed6f0a07",
            "port": "26aba23f-8567-4e9b-bd45-c26724030f33"
          }
        },
        {
          "source": {
            "block": "327a405d-f51c-4d69-bb6e-84657c8bd2df",
            "port": "constant-out"
          },
          "target": {
            "block": "29419937-2d03-4f3b-a558-a759ed6f0a07",
        ...
        {
          "source": {
            "block": "7020b175-68a3-484b-ab5a-8cec99bf9e22",
            "port": "out"
          },
          "target": {
            "block": "29419937-2d03-4f3b-a558-a759ed6f0a07",
        ...
        },
        {
          ...
          "target": {
            "block": "8460c821-eb3b-4487-b95c-f4e0be56043c",
        ...
        },
        {
          ...
          "target": {
            "block": "814c2dff-7346-450a-99f4-c1bca0710e7b",
            "port": "in"
          },
          "size": 7
        },
