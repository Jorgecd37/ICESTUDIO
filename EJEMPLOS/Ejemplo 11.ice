{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "b7518c71-2ace-4c9f-a5e2-eb0ef2985106",
          "type": "basic.output",
          "data": {
            "name": "Zumbador",
            "pins": [
        ...
        {
          "id": "33c8cb24-346f-4be3-88f0-b6366f563a08",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[1:0]",
        ...
        {
          "id": "884e1680-fab6-4d86-9ed6-b7410123bb6a",
          "type": "basic.input",
          "data": {
            "name": "Boton1",
            "pins": [
        ...
        {
          "id": "c93099fe-51dd-42e2-a0b6-a0ae76bf35f1",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "10",
        ...
        {
          "id": "8d53b45f-0b18-4a48-8a42-ba4d2ff96f39",
          "type": "basic.constant",
          "data": {
            "name": "Modulo",
            "value": "4",
        ...
        {
          "id": "f1bc4ab9-5b7e-4cbf-852c-2646be739feb",
          "type": "basic.constant",
          "data": {
            "name": "Modulo",
            "value": "10",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 11: Contador de vueltas de un spinner\n\nContar el numero de vueltas de un sinner (de 0 a 9). Se detecta una vuelta completa cuando se han recibido los 3 ticks que\nse producen los 3 brazos cruzan el sensor IR. Cada vez que cruza un brazo se emite un tic. Primero se pasa por un \ntemporizador para emitir un pitido de 10ms y su salida se conecta al detector de vueltas: un contador modulo 3. Este a su\nvez se conecta al contador de vueltas, cuyo resultado se muestra en un display 7 segmentos.\n",
            "readonly": true
          },
          "position": {
            "x": -688,
        ...
        {
          "id": "979b324e-3a56-48a2-b495-86614d21f837",
          "type": "basic.info",
          "data": {
            "info": "Duracion del pitido\nde deteccion de brazo\ndel spinner",
            "readonly": true
          },
          "position": {
            "x": -360,
        ...
        {
          "id": "c548262a-3442-4b0f-b4e7-d0ac070f2311",
        ...
        {
          "id": "0ff20d38-966f-4d02-89ff-7217c274cd3e",
        ...
        {
          "id": "09abbaf3-aa27-45f6-9677-a26e40438c8e",
        ...
        {
          "id": "48e097b9-ef2a-4d45-8bc4-f2f7b236104d",
          "type": "basic.info",
          "data": {
            "info": "Detector de vuelta \ncompleta\n",
            "readonly": true
          },
          "position": {
            "x": 16,
        ...
        {
          "id": "464c5cd8-7b51-4381-aae8-6cd292f43e5d",
          "type": "basic.info",
          "data": {
            "info": "Evento vuelta\ncompleta",
            "readonly": true
        ...
        {
          "id": "e4e1f7cc-a4eb-4e4e-9616-79fae62ed2e9",
          "type": "basic.info",
          "data": {
            "info": "IR de ticks",
            "readonly": true
        ...
        {
          "id": "5571d45a-c94d-45a3-b47b-1269949470d4",
          "type": "basic.info",
          "data": {
            "info": "Mostrar el contador de brazzos detectados \npor vuelta",
            "readonly": true
          },
          "position": {
            "x": 152,
        ...
        {
          "id": "07291a3f-b4cb-425f-a78a-a90285fa8c42",
          "type": "basic.info",
          "data": {
            "info": "Unidades",
            "readonly": true
        ...
        {
          "id": "87e8d5e5-c7e4-4ce9-9b5d-be55ea58a2d6",
          "type": "basic.info",
          "data": {
            "info": "DisplayBit3\n",
            "readonly": true
        ...
        {
          "id": "0f713048-97a3-4c41-ac14-5f6bf8979f4f",
          "type": "basic.info",
          "data": {
            "info": "Contador de vuletas del spinner",
            "readonly": true
          },
          "position": {
            "x": 312,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "c93099fe-51dd-42e2-a0b6-a0ae76bf35f1",
            "port": "constant-out"
          },
          "target": {
            "block": "a963ed4a-54d0-48b4-a1b4-ceab60473011",
        ...
        },
        {
          ...
          "target": {
            "block": "b7518c71-2ace-4c9f-a5e2-eb0ef2985106",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "c548262a-3442-4b0f-b4e7-d0ac070f2311",
            "port": "26aba23f-8567-4e9b-bd45-c26724030f33"
          }
        },
        {
          "source": {
            "block": "8d53b45f-0b18-4a48-8a42-ba4d2ff96f39",
            "port": "constant-out"
          },
          "target": {
            "block": "c548262a-3442-4b0f-b4e7-d0ac070f2311",
        ...
        {
          "source": {
            "block": "0ff20d38-966f-4d02-89ff-7217c274cd3e",
            "port": "c659caa2-1cf7-4da3-855a-2b0c0ecc7510"
          },
          "target": {
            "block": "09abbaf3-aa27-45f6-9677-a26e40438c8e",
        ...
        {
          "source": {
            "block": "884e1680-fab6-4d86-9ed6-b7410123bb6a",
            "port": "out"
          },
          "target": {
            "block": "0ff20d38-966f-4d02-89ff-7217c274cd3e",
        ...
        {
          "source": {
            "block": "f1bc4ab9-5b7e-4cbf-852c-2646be739feb",
            "port": "constant-out"
          },
          "target": {
            "block": "0ff20d38-966f-4d02-89ff-7217c274cd3e",
        ...
        },
        {
          ...
          "target": {
            "block": "33c8cb24-346f-4be3-88f0-b6366f563a08",
            "port": "in"
          },
          "size": 2
        }
