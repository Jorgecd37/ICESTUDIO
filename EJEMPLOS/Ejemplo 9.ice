  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "700386e7-40ab-4909-89a9-33753e935b8f",
          "type": "basic.output",
          "data": {
            "name": "LED ",
            "range": "[1:0]",
        ...
        {
          "id": "2ebb7ad0-994c-4135-bbd2-a9ed6cf29316",
          "type": "basic.constant",
          "data": {
            "name": "Modulo",
            "value": "3",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 9: Contando pulsaciones triples\n\nEl contador uno cuenta pulsaciones de boton. Como su modulo es 3, solo cuenta\n3 pulsaciones y emite un evento, que se interpreta como. \"Boton apretado\ntres veces\". El contaor 2 cuenta el numero de triples clicks apretados.\nEs de 3 bits, por lo que puede contar hasta 8 triples clicks y luego vuelve a\nempezar.",
            "readonly": true
          },
          "position": {
            "x": -344,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Reset de los dos contadores\n\n",
            "readonly": true
          },
          "position": {
            "x": -136,
        ...
        {
          "id": "4d3d9cbe-f548-4e92-8396-578cb9aa5775",
        ...
        {
          "id": "5ed131a4-cb34-4065-8e6e-259999b4c91b",
          "type": "basic.info",
          "data": {
            "info": "Contador 1 \nen binario",
            "readonly": true
        ...
        {
          "id": "51388b4d-eee2-489b-b30d-bf808eaf9c64",
          "type": "basic.info",
          "data": {
            "info": "Incrementar \n\ncontador 2\n",
            "readonly": true
        ...
        {
          "id": "b9ceca70-2379-4ec2-a636-1217e05ecd9e",
          "type": "basic.info",
          "data": {
            "info": "Contador 1\n\n2 bits",
            "readonly": true
        ...
        {
          "id": "cd7ce131-ddba-4a87-9643-04cc720e115f",
        ...
        {
          "id": "f4953cac-bdfc-4a19-b5d5-4e7f94968a2b",
        ...
        {
          "id": "c1d21e4f-41a0-471b-a0b0-ca8025bef61f",
          "type": "basic.info",
          "data": {
            "info": "Evento:\nBoton apretado\n3 veces",
            "readonly": true
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "4d3d9cbe-f548-4e92-8396-578cb9aa5775",
        ...
        },
        {
          ...
          "target": {
            "block": "700386e7-40ab-4909-89a9-33753e935b8f",
            "port": "in"
          },
          "size": 2
        },
        {
          "source": {
            "block": "2ebb7ad0-994c-4135-bbd2-a9ed6cf29316",
            "port": "constant-out"
          },
          "target": {
            "block": "4d3d9cbe-f548-4e92-8396-578cb9aa5775",
        ...
        },
        {
          ...
          "target": {
            "block": "f4953cac-bdfc-4a19-b5d5-4e7f94968a2b",
            "port": "743b5299-2d89-4783-b7c9-12a5b36df406"
          }
        },
        {
          ...
          "target": {
            "block": "cd7ce131-ddba-4a87-9643-04cc720e115f",
