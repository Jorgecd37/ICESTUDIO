  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "5c37f752-9129-4820-89a9-f21fc8d3791f",
          "type": "basic.output",
          "data": {
            "name": "LED ",
            "range": "[1:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Ejemplo 3: Contando en decimal\n\nMostramos la cuenta del 0 al 3 en un display de 7 segemmentos. Es el \nmismoo ejemplo que el 2, pero ahora ademas de ver la cuenta en binario\nla vemos en digitos decimales. la cosa cambia mucho.",
            "readonly": true
          },
          "position": {
            "x": -56,
        ...
        {
          "id": "05bac21d-5a43-4a05-822b-cf6040997a8c",
          "type": "basic.info",
          "data": {
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "5c37f752-9129-4820-89a9-f21fc8d3791f",
            "port": "in"
          },
          "size": 2
        },
